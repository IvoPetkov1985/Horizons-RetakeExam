...
namespace Horizons.Migrations
{
    ...
    [Migration("20241211130838_TablesWithDataCreated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Horizons.Data.DataModels.Destination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Description")
                        ...
                        .HasComment("Detailed information about the destination");

                    b.Property<string>("ImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasComment("Link to a photo from the place");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit")
                        .HasComment("Is the ad outdated, set as inactive");
                    ...
                    b.Property<DateTime>("PublishedOn")
                        ...
                        .HasComment("When the ad was published on the platform");
                    ...
                    b.ToTable("Destinations", t =>
                        {
                            t.HasComment("Bulgarian destination");
                        });
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Rila Monastery",
                            PublishedOn = new DateTime(2024, 12, 11, 15, 8, 37, 264, DateTimeKind.Local).AddTicks(2590),
                        ...
                        new
                        {
                            ...
                            PublishedOn = new DateTime(2024, 12, 11, 15, 8, 37, 264, DateTimeKind.Local).AddTicks(2678),
                            PublisherId = "7699db7d-964f-4782-8209-d76562e0fece",
                            TerrainId = 2
                        },
                        new
                        {
                            ...
                            PublishedOn = new DateTime(2024, 12, 11, 15, 8, 37, 264, DateTimeKind.Local).AddTicks(2693),
                            PublisherId = "7699db7d-964f-4782-8209-d76562e0fece",
                            TerrainId = 7
                        });
                });

            modelBuilder.Entity("Horizons.Data.DataModels.Terrain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Horizons.Data.DataModels.UserDestination", b =>
                {
                    ...
                    b.ToTable("UsersDestinations", t =>
                        {
                            t.HasComment("The relational table between users and marked destinations as favorite");
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d79d5357-dc24-4922-a46a-1cd7dcf4af5e",
                            Email = "admin@horizons.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@HORIZONS.COM",
                            NormalizedUserName = "ADMIN@HORIZONS.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEDAEpgw/l/PMbImqgNpF1IKm1qDay+1z9rjcawYLtNzNiDZlpKE0biS700m6qCMrdA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "fc8bcbc5-bfd9-4f57-b0db-fe5b5dd26b6b",
            ...
            modelBuilder.Entity("Horizons.Data.DataModels.Destination", b =>
                {
                    ...
                    b.HasOne("Horizons.Data.DataModels.Terrain", "Terrain")
            ...
            modelBuilder.Entity("Horizons.Data.DataModels.UserDestination", b =>
                {
                    b.HasOne("Horizons.Data.DataModels.Destination", "Destination")
